...
<%	
	...
	if (request.getParameter("date") != null){
		int DATE = QueryHourNTCH.dateToInt(request.getParameter("date"));
		int TIME_S = startTime * 10000;
		int TIME_E = endTime * 10000;
		int CELLID = Integer.parseInt(request.getParameter("cellid"));
		ls = QueryHourNTCH.select(DATE, TIME_S, TIME_E, CELLID);
	}
%>
...
<body>
	<center><h1><%out.print(date + "的小时级每线话务量"); %></h1></center>
	<div>
