...
<%	
	...
	if (request.getParameter("date") != null){
		DATE = QueryMinuteTraff.dateToInt(request.getParameter("date"));
		TIME_S = startTime * 10000;
		TIME_E = endTime * 10000;
		CELLID = Integer.parseInt(request.getParameter("cellid"));
		ls = QueryMinuteTraff.select(DATE, TIME_S, TIME_E, CELLID);
	}
%>
...
<body>
	<center><h1><%out.print(date + "的分钟级话务量"); %></h1></center>
	<div>
